...
Usage:
    ...
    python3 .agents/skills/fix-department/scripts/gem_progress.py --gem rubocop-performance
    python3 .agents/skills/fix-department/scripts/gem_progress.py --gem rubocop-performance --input corpus-results.json
"""
