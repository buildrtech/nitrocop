...
- Rails/RakeEnvironment candidate: add conservative RuboCop-style autocorrect that inserts `:environment` dependency for offense patterns while preserving hash-arg/argument-list styles.
