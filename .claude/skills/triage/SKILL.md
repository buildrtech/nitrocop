...
After identifying targets, use `investigate_cop.py` to see all FP/FN locations with source context:

```bash
python3 scripts/investigate_cop.py Department/CopName --context --fp-only
```
